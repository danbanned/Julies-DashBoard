...
export const SOURCES = [
  ...
  // 21e: stubbed, no live ingestion yet — Julie hasn't provided API access/
  // scraping details. Seeded as an empty feed so wiring in real Eventbrite
  // data later is a config change (FIELD_MAP + this file), not new plumbing.
  { id: "eventbrite",    file: "eventbrite_events.json",           label: "Eventbrite", bigByDefault: false },
];
...
export const FIELD_MAP = {
  ...
  // 21e: placeholder — fill in once Eventbrite's real field names are known.
  eventbrite: {},
};
